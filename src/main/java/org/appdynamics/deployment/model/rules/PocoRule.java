...
public class PocoRule {
	...
	public String toString() {
		return "PocoRule [enabled=" + enabled + ", priority=" + priority + ", displayName=" + displayName + ", background=" + background + ", matchClass=" + matchClass + ", splitConfig=" + splitConfig + ", matchMethod=" + matchMethod + "]";
	}
